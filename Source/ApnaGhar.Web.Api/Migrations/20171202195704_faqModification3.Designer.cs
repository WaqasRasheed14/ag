...
namespace ApnaGhar.Web.Api.Migrations
{
    ...
    [Migration("20171202195704_faqModification3")]
    partial class faqModification3
    {
            ...
            modelBuilder.Entity("ApnaGhar.Models.Lookups.LookupCity", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 12, 3, 3, 57, 4, 386, DateTimeKind.Local));

                    b.Property<int>("CreatedBy");

                    b.Property<DateTime>("ModifiedAt")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 12, 3, 3, 57, 4, 392, DateTimeKind.Local));
