...
namespace ApnaGhar.Web.Api.Migrations
{
    ...
    [Migration("20171202191427_faqModification")]
    partial class faqModification
    {
            ...
            modelBuilder.Entity("ApnaGhar.Models.Lookups.LookupCity", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 12, 3, 3, 14, 26, 473, DateTimeKind.Local));

                    b.Property<int>("CreatedBy");

                    b.Property<DateTime>("ModifiedAt")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 12, 3, 3, 14, 26, 483, DateTimeKind.Local));
